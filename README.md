...
[![Test](https://github.com/ymdarake/grass-chopper/actions/workflows/test.yml/badge.svg)](https://github.com/ymdarake/grass-chopper/actions/workflows/test.yml)
...
- **TDD**: テストファースト。212 テストが Mac ホストで即時実行可能
...
```bash
make test-pure       # 純粋ロジックテスト 212件 (Mac, rclpy 不要)
...
| test_incline_monitor.py | 傾斜検知 (フィルタ・キャリブレーション含む) | 36 |
